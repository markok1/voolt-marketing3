$(document).ready(function () {
  ...
  (function ($) {
    ...
    if (section.length) {
      $(".does-item:first-child .inside-box .answer").slideToggle();
      $(".does-item:first-child .image-box").slideToggle();
      $(".does-item").click(function (e) {
        e.preventDefault();
        if ($(this).hasClass("opened-box")) {
          $(this).removeClass("opened-box");
          $(this).find(".image-box").removeClass("does-active-img");
          $(this).find(".answer").slideUp(150);
          $(this).find(".image-box").slideUp(150);
        } else {
          $(".does-item").removeClass("opened-box");
          $(".does-item .answer").slideUp(150);
          $(".image-box").removeClass("does-active-img");
          $(".image-box").slideUp(150);
          $(this).addClass("opened-box");
          $(this).find(".answer").slideDown(150);
          $(this).find(".image-box").addClass("does-active-img");
          $(this).find(".image-box").slideDown(150);
        }
      });
    }
  })(jQuery);
